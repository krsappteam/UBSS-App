...
export const Menu = ({ color = '#fff', size = 32 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const WhatsApp = ({ color = '#fff', size = 26 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const Microphone = ({ color = '#757575', size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 14C13.66 14 15 12.66 15 11V5C15 3.34 13.66 2 12 2C10.34 2 9 3.34 9 5V11C9 12.66 10.34 14 12 14ZM17.91 11C17.42 11 17.01 11.36 16.93 11.84C16.57 13.97 14.73 15.5 12.5 15.5C10.27 15.5 8.43 13.97 8.07 11.84C7.99 11.36 7.58 11 7.09 11C6.52 11 6.07 11.52 6.15 12.08C6.58 14.63 8.73 16.59 11.38 16.93V19H9C8.45 19 8 19.45 8 20C8 20.55 8.45 21 9 21H15C15.55 21 16 20.55 16 20C16 19.45 15.55 19 15 19H12.62V16.93C15.27 16.59 17.42 14.63 17.85 12.08C17.93 11.52 17.48 11 16.91 11Z" fill={color} />
  </Svg>
);
...
export const Home = ({ color = '#3f73b9', size = 28 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const CheckDecagram = ({ color = '#4CAF50', size = 18 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M23 12L20.56 9.22L20.9 5.54L17.29 4.72L15.4 1.54L12 3L8.6 1.54L6.71 4.72L3.1 5.53L3.44 9.21L1 12L3.44 14.78L3.1 18.47L6.71 19.29L8.6 22.47L12 21L15.4 22.46L17.29 19.28L20.9 18.46L20.56 14.78L23 12ZM10.09 16.72L6.29 12.91L7.77 11.43L10.09 13.76L15.94 7.89L17.42 9.37L10.09 16.72Z" fill={color} />
  </Svg>
);

export const EmailOutline = ({ color = '#666', size = 14 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const MapMarkerRadius = ({ color = '#666', size = 14 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const DoorOpen = ({ color = '#666', size = 18 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 3C10.9 3 10 3.9 10 5H3V19H10V21H21V5C21 3.9 20.1 3 19 3H12ZM12 5H19V19H12V5ZM16 11V13H14V11H16Z" fill={color} />
  </Svg>
);

export const Account = ({ color = '#666', size = 18 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 4C14.21 4 16 5.79 16 8C16 10.21 14.21 12 12 12C9.79 12 8 10.21 8 8C8 5.79 9.79 4 12 4ZM12 14C16.42 14 20 15.79 20 18V20H4V18C4 15.79 7.58 14 12 14Z" fill={color} />
  </Svg>
);

export const ChevronLeft = ({ color = '#666', size = 24 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const EyeOutline = ({ color = '#666', size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 9C13.66 9 15 10.34 15 12C15 13.66 13.66 15 12 15C10.34 15 9 13.66 9 12C9 10.34 10.34 9 12 9ZM12 4.5C17 4.5 21.27 7.61 23 12C21.27 16.39 17 19.5 12 19.5C7 19.5 2.73 16.39 1 12C2.73 7.61 7 4.5 12 4.5ZM12 17C14.76 17 17 14.76 17 12C17 9.24 14.76 7 12 7C9.24 7 7 9.24 7 12C7 14.76 9.24 17 12 17Z" fill={color} />
  </Svg>
);

export const EyeOffOutline = ({ color = '#666', size = 20 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M12 7C14.76 7 17 9.24 17 12C17 12.65 16.87 13.26 16.64 13.83L19.56 16.75C21.07 15.49 22.26 13.86 23 12C21.27 7.61 17 4.5 12 4.5C10.6 4.5 9.26 4.75 8 5.2L10.17 7.37C10.74 7.13 11.35 7 12 7ZM2 4.27L4.28 6.55L4.74 7.01C3.08 8.3 1.78 10.02 1 12C2.73 16.39 7 19.5 12 19.5C13.55 19.5 15.03 19.2 16.38 18.66L16.8 19.08L19.73 22L21 20.73L3.27 3L2 4.27ZM7.53 9.8L9.08 11.35C9.03 11.56 9 11.78 9 12C9 13.66 10.34 15 12 15C12.22 15 12.44 14.97 12.65 14.92L14.2 16.47C13.53 16.8 12.79 17 12 17C9.24 17 7 14.76 7 12C7 11.21 7.2 10.47 7.53 9.8ZM11.84 9.02L14.99 12.17L15.01 12.01C15.01 10.35 13.66 9 12 9L11.84 9.02Z" fill={color} />
  </Svg>
);

export const CheckboxOutline = ({ color = '#004e82', size = 22 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path d="M19 3H5C3.89 3 3 3.9 3 5V19C3 20.1 3.89 21 5 21H19C20.11 21 21 20.1 21 19V5C21 3.9 20.11 3 19 3ZM19 19H5V5H19V19ZM17.99 9L16.58 7.58L9.99 14.17L7.41 11.6L5.99 13.01L9.99 17L17.99 9Z" fill={color} />
  </Svg>
);

export const SquareOutline = ({ color = '#666', size = 22 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
